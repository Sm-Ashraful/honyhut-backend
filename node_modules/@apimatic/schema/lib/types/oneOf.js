...
function createOneOfWithDiscriminator(schemas, discriminatorMap, discriminatorField) {
    return {
        type: function () { return "OneOf<" + schemas.map(function (schema) { return schema.type(); }).join(' | ') + ">"; },
...
function validateSchemas(schemas, ctxt) {
    ...
    return ctxt.fail("Matched more than one type. Matched types include: " + schemas
